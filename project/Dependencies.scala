...
object Dependencies {
  private lazy val circeVersion = "0.14.7"
  private lazy val softWareMillVersion = "3.9.6"
  private lazy val keycloakVersion = "24.0.4"
  ...
  lazy val jbossLogging = "org.jboss.logging" % "jboss-logging" % "3.6.0.Final"
